  ...
  return (
    <Layout>
      ...
      <div className="projectDetailContainer">
        ...
        <ul>
          { project.url && <li><a href={project.url} target="_blank" rel="noreferrer" >View The Site</a></li> }
          { project.github && <li><a href={project.github} target="_blank" rel="noreferrer" >View Github</a></li>}
